...
```{r}
#INPUT: Y an n by g matrix of phenotypes
# X an n by K matrix of covariates (Typically columns of X will be the PCs, and K=n since there are n PCs)
...
#Y = scale(Y,scale=scaleY) #remove column means, and  scale if scale=T
